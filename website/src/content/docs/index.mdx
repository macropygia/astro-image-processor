...
<Aside type="caution">
  Currently under early development. It will be developed internally for a while. All specifications
  are subject to change without notice, including those involving breaking changes.
</Aside>
...
<CardGrid>
  ...
  <LinkCard
    title="npm"
    href="https://www.npmjs.com/package/astro-image-processor"
    target="_blank"
  />
</CardGrid>
