...
<!-- dist/index.html -->
<!DOCTYPE html>
<html lang="en" data-astro-cid-5w3lc6bc>
...
<head>
  ...
  <style>
    ...
    .foo[data-astro-cid-5w3lc6bc] {
      position: relative
    }
    .bar[data-astro-cid-5w3lc6bc] {
      padding: 20px
    }
    .baz[data-astro-cid-5w3lc6bc] {
      color: red
    }
  </style>
  <script type="module">
...
<body data-astro-cid-5w3lc6bc>
  <h1 data-astro-cid-5w3lc6bc>Astro Image Processor</h1>
  <section data-astro-aip-8c2980cb data-astro-cid-5w3lc6bc class="foo bar">
    <picture class="aip-elm-picture aip-elm-as-background aip-layout-constrained"
             data-astro-aip-8c2980cb data-astro-cid-5w3lc6bc>
    ...
    <p class="baz" data-astro-cid-5w3lc6bc>slot</p>
  </section>
</body>
