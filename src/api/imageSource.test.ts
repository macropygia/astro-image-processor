...
describe('Unit/api/ImageSource', () => {
  ...
  test('imageClassList', async () => {
    ...
    expect(instance.imageClassList).toEqual(['aip-elm-img', 'astro-aip-mockHash']);
  ...
  test('containerClassList', async () => {
    ...
    expect(notAttr).toEqual(['aip-elm-container', 'astro-aip-mockHash', 'aip-layout-constrained']);
