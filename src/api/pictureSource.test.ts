// @ts-nocheck
import { type Mock, afterAll, beforeEach, describe, expect, test, vi } from 'vitest';
...
describe('Unit/api/PictureSource', () => {
  ...
  test('asBackground', async () => {
    ...
    expect(classList).toEqual(['aip-elm-picture', 'astro-aip-mockHash', 'aip-elm-as-background']);
  });
